...
const EXTRA_KEYWORDS = {
  ...
  meeting: ['besprechung', 'video', 'call', 'meeting', 'webinar', 'konferenz'],
  calendar: ['termin', 'kalender', 'default', 'appointment'],
  stethoscope: ['arzt', 'gesundheit', 'doctor'],
  'party-popper': ['feier', 'party'],
  utensils: ['essen', 'restaurant'],
  video: ['meeting', 'call', 'kamera', 'webinar', 'teams', 'besprechung', 'online'],
  footprints: ['laufen', 'walk'],
  presentation: ['präsentation', 'folien', 'webinar', 'vortrag', 'slides'],
  'screen-share': ['bildschirm', 'teilen', 'webinar', 'demo'],
  'monitor-play': ['stream', 'webinar', 'präsentation', 'video'],
  projector: ['beamer', 'präsentation', 'meeting', 'raum'],
  webcam: ['kamera', 'video', 'meeting', 'webinar'],
  podcast: ['podcast', 'aufnahme', 'audio', 'webinar'],
  mic: ['mikrofon', 'sprechen', 'webinar', 'aufnahme'],
  'mic-vocal': ['mikrofon', 'stimme', 'webinar', 'sing'],
  headset: ['kopfhörer', 'call', 'support', 'meeting'],
  megaphone: ['ankündigung', 'webinar', 'marketing'],
  radio: ['live', 'broadcast', 'webinar'],
  cast: ['stream', 'cast', 'teilen'],
  users: ['gruppe', 'team', 'leute', 'meeting', 'teilnehmer'],
  'users-round': ['gruppe', 'team', 'meeting', 'teilnehmer'],
  'user-round': ['person', 'einzeltermin', '1:1'],
  handshake: ['partnerschaft', 'deal', 'meeting', 'kundentermin'],
  'messages-square': ['chat', 'diskussion', 'meeting'],
  phone: ['telefon', 'anruf', 'call'],
  'phone-call': ['telefon', 'anruf', 'call', 'meeting'],
  briefcase: ['geschäft', 'büro', 'meeting', 'arbeit'],
  'briefcase-business': ['geschäft', 'business', 'meeting'],
  'building-2': ['büro', 'firma', 'ort', 'meeting'],
  'map-pin': ['ort', 'location', 'karte', 'termin'],
  clock: ['uhrzeit', 'termin', 'zeit'],
  'alarm-clock': ['erinnerung', 'wecker', 'termin'],
  timer: ['dauer', 'countdown', 'zeit'],
  coffee: ['kaffee', 'pause', 'informell', 'meeting'],
  'clipboard-list': ['agenda', 'liste', 'meeting', 'aufgaben'],
  'notebook-pen': ['notizen', 'protokoll', 'meeting'],
  clapperboard: ['produktion', 'aufnahme', 'webinar', 'film'],
  tv: ['fernsehen', 'stream', 'webinar'],
  airplay: ['spiegeln', 'präsentieren', 'meeting']
}
