...
import { listSubtleBorderClass, settingsSectionClass, settingsTileClass } from '@/lib/chronell-ui-classes'
...
export function NotionSettingsPanel({
  ...
  return (
    <section className={cn('space-y-3 p-3', settingsSectionClass)}>
      ...
      {status?.connected ? (
        <div className={cn('space-y-3 border-t pt-3', listSubtleBorderClass)}>
              ...
              <ul className="max-h-52 space-y-1 overflow-y-auto">
                {destinations.favorites.map((f) => {
                  ...
                  return (
                    <li
                      key={f.id}
                      className={cn('flex items-start gap-2 px-2 py-1.5', settingsTileClass)}
                    >
                      <Star
          ...
          <div className="space-y-2">
            ...
            {searchHits.length > 0 ? (
              <ul className="max-h-36 space-y-1 overflow-y-auto rounded-md bg-muted/15 p-1">
                {searchHits.map((h) => {
