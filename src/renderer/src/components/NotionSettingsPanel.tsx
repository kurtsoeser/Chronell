...
export function NotionSettingsPanel({
  ...
  return (
    <section className="space-y-3 rounded-md border border-border/35 bg-muted/20 p-3">
      ...
      <details className="rounded-md border border-border/35 bg-background/30">
        ...
        <div className="space-y-2 border-t border-border/30 px-3 py-3">
          ...
          <p className="rounded-md border border-border/30 bg-background/50 px-2 py-1.5 font-mono text-[10px] leading-relaxed text-muted-foreground">
      ...
      {status?.connected ? (
        <div className="space-y-3 border-t border-border/30 pt-3">
          ...
          <div className="space-y-2 rounded-md border border-border/35 bg-background/40 p-2">
              ...
              <ul className="max-h-52 space-y-1 overflow-y-auto">
                {destinations.favorites.map((f) => {
                  ...
                  return (
                    <li
                      key={f.id}
                      className="flex items-start gap-2 rounded-md border border-border/28 bg-muted/20 px-2 py-1.5"
                    >
                      <Star
          ...
          <div className="space-y-2">
            ...
            {searchHits.length > 0 ? (
              <ul className="max-h-36 space-y-1 overflow-y-auto rounded-md border border-border/30 p-1">
                {searchHits.map((h) => {
