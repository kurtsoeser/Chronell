...
export const DEFAULT_APP_CONFIG: AppConfig = {
  ...
  syncWindowDays: 90,
  mailPollIntervalSeconds: 30,
  /** Graph fuer Mail-Sync: zuverlaessiger als EWS-Auto (EWS kann 0 Mails liefern bei gesetztem Sync-Token). */
  microsoftMailTransport: 'graph',
  mailBodyIndexEnabled: true,
  mailBodyIndexSpeed: 'normal',
  autoLoadImages: true,
  gravatarEnabled: false,
  contactPhotoAvatarEnabled: true,
  senderDomainAvatarEnabled: true,
  accountProfileAvatarEnabled: true,
  launchOnLogin: false,
