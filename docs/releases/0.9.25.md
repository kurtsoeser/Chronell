...
title-de: Mail und Dateien
title-en: Mail and Files
...
- **Files:** New Files module: cloud files, mail attachments, and index sync
- **Calendar:** Calendar and events: dialog, preview, categories, and shell
- **Homepage:** Release notes, homepage timeline, and download for 0.9.25
